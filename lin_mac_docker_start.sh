...
ln -sf $ODOO_PATH $PROJECT_DIR_PATH
cd $OODOO_PROJECT_DIR_PATH
ln -sf $OODOO_PROJECT_DIR_PATH $PROJECT_DIR_PATH
...
INSTALL_MODULES="hr_timesheet_name_customer"
...
UPDATE_MODULES="hr_timesheet_name_customer"
